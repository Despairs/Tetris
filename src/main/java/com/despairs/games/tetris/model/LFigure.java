...
public class LFigure extends BaseFigure {
    ...
    public LFigure() {
        ...
        ((Polygon)figure).addPoint(AppConfig.START_POSITION + AppConfig.BLOCK_SIZE, AppConfig.START_POSITION + 3 * AppConfig.BLOCK_SIZE);
        ((Polygon)figure).addPoint(AppConfig.START_POSITION, AppConfig.START_POSITION + 3 * AppConfig.BLOCK_SIZE);
        ((Polygon)figure).addPoint(AppConfig.START_POSITION, AppConfig.START_POSITION);
    }
